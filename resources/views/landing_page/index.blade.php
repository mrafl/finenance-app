...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ jadoo('assets/img/favicons/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png')}}" sizes="32x32" href="{{ jadoo('assets/img/favicons/favicon-32x32.png') }}">
    <link rel="icon" type="image/png')}}" sizes="16x16" href="{{ jadoo('assets/img/favicons/favicon-16x16.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ jadoo('assets/img/favicons/favicon.ico') }}">
    <link rel="manifest" href="{{ jadoo('assets/img/favicons/manifest.json') }}">
    <meta name="msapplication-TileImage" content="{{ jadoo('assets/img/favicons/mstile-150x150.png') }}">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{ jadoo('assets/css/theme.css') }}" rel="stylesheet" />
...
<body>
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-5 d-block"
            ...
            <div class="container"><a class="navbar-brand" href="index.html"><img
                        src="{{ jadoo('assets/img/logo.svg') }}" height="34" alt="logo" /></a>
                ...
                <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base align-items-lg-center align-items-start">
                        ...
                        <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page"
                                href="#destination">Olahraga</a></li>
                        <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page"
                                href="#booking">Pemesanan</a></li>
                        <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page"
        ...
        <section style="padding-top: 7rem;">
            <div class="bg-holder" style="background-image:url({{ jadoo('assets/img/hero/hero-bg.svg') }});">
            </div>
            <!--/.bg-holder-->
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-5 col-lg-6 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 hero-img"
                            src="{{ jadoo('assets/img/badmintonMen.png') }}" alt="hero-header" /></div>
                    <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
                        <h4 class="fw-bold text-success mb-3">Temukan tempat terbaik untuk olahraga mu!</h4>
                        <h1 class="hero-title">Yuk olahraga dan rasakan manfaatnya</h1>
                        <p class="mb-4 fw-medium">Olahraga disaat pandemi bukanlah hal yang buruk.
                            <br class="d-none d-xl-block" />Jangan rebahan terus dan mulailah berolahraga bersama kami
                            <br class="d-none d-xl-block" />Ajak teman mu dan selamat berolahraga!
                        </p>
                        <div class="text-center text-md-start"> <a
                                class="btn btn-success btn-lg me-md-4 mb-3 mb-md-0 border-0 primary-btn-shadow"
                                href="#!" role="button">Mulai</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="pt-5 pt-md-9" id="service">
            ...
            <div class="container">
                <div class="position-absolute z-index--1 end-0 d-none d-lg-block"><img
                        src="{{ jadoo('assets/img/category/shape.svg') }}" style="max-width: 200px" alt="service" />
                </div>
                <div class="mb-7 text-center">
                    <h5 class="text-secondary">CATEGORY </h5>
                    <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize">Kami Menawarkan Layanan
                        Terbaik</h3>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-sm-6 mb-6">
                        <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                            <div class="card-body p-xxl-5 p-4"> <img
                                    src="{{ jadoo('assets/img/category/icon1.png') }}" width="75" alt="Service" />
                    ...
                    <div class="col-lg-3 col-sm-6 mb-6">
                        <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                            <div class="card-body p-xxl-5 p-4"> <img
                                    src="{{ jadoo('assets/img/category/icon2.png') }}" width="75" alt="Service" />
                    ...
                    <div class="col-lg-3 col-sm-6 mb-6">
                        <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                            <div class="card-body p-xxl-5 p-4"> <img
                                    src="{{ jadoo('assets/img/category/icon3.png') }}" width="75" alt="Service" />
                    ...
                    <div class="col-lg-3 col-sm-6 mb-6">
                        <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                            <div class="card-body p-xxl-5 p-4"> <img
                                    src="{{ jadoo('assets/img/category/icon4.png') }}" width="75" alt="Service" />
        ...
        <section class="pt-5" id="destination">
            ...
            <div class="container">
                <div class="position-absolute start-100 bottom-0 translate-middle-x d-none d-xl-block ms-xl-n4"><img
                        src="{{ jadoo('assets/img/dest/shape.svg') }}" alt="destination" /></div>
                <div class="mb-7 text-center">
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <div class="card overflow-hidden shadow"> <img class="card-img-top"
                                src="{{ jadoo('assets/img/dest/dest1.jpg') }}" alt="Rome, Italty" />
                            <div class="card-body py-4 px-3">
                                ...
                                <div class="d-flex align-items-center"> <img
                                        src="{{ jadoo('assets/img/dest/navigation.svg') }}"
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card overflow-hidden shadow"> <img class="card-img-top"
                                src="{{ jadoo('assets/img/dest/dest2.jpg') }}" alt="London, UK" />
                            <div class="card-body py-4 px-3">
                                <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                                    <h4 class="text-secondary fw-medium"><a
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card overflow-hidden shadow"> <img class="card-img-top"
                                src="{{ jadoo('assets/img/dest/dest3.jpg') }}" alt="Full Europe" />
                            <div class="card-body py-4 px-3">
                                <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                                    <h4 class="text-secondary fw-medium"><a
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex align-items-start mb-5">
                            <div class="bg-primary me-sm-4 me-3 p-3" style="border-radius: 13px"> <img
                                    src="{{ jadoo('assets/img/steps/selection.svg') }}" width="22" alt="steps" />
                            </div>
                            <div class="flex-1">
                        ...
                        <div class="d-flex align-items-start mb-5">
                            <div class="bg-danger me-sm-4 me-3 p-3" style="border-radius: 13px"> <img
                                    src="{{ jadoo('assets/img/steps/water-sport.svg') }}" width="22" alt="steps" />
                            </div>
                            <div class="flex-1">
                        ...
                        <div class="d-flex align-items-start mb-5">
                            <div class="bg-info me-sm-4 me-3 p-3" style="border-radius: 13px"> <img
                                    src="{{ jadoo('assets/img/steps/taxi.svg') }}" width="22" alt="steps" /></div>
                            <div class="flex-1">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-start">
                        <div class="card position-relative shadow" style="max-width: 370px;">
                            <div class="position-absolute z-index--1 me-10 me-xxl-0" style="right:-160px;top:-210px;">
                                <img src="{{ jadoo('assets/img/steps/bg.png') }}" style="max-width:550px;"
                                    alt="shape" />
                            </div>
                            <div class="card-body p-3"> <img class="mb-4 mt-2 rounded-2 w-100"
                                    src="{{ jadoo('assets/img/steps/booking-img.jpg') }}" alt="booking" />
                                <div>
                                    ...
                                    <div class="icon-group mb-4"> <span class="btn icon-item"> <img
                                                src="{{ jadoo('assets/img/steps/leaf.svg') }}" alt="" /></span><span
                                            class="btn icon-item"> <img
                                                src="{{ jadoo('assets/img/steps/map.svg') }}" alt="" /></span><span
                                            class="btn icon-item"> <img
                                                src="{{ jadoo('assets/img/steps/send.svg') }}" alt="" /></span>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center mt-n1"><img class="me-3"
                                                src="{{ jadoo('assets/img/steps/building.svg') }}" width="18"
                                        ...
                                        <div class="show-onhover position-relative">
                                                ...
                                                <div class="card-body py-3">
                                                    <div class="d-flex">
                                                        <div style="margin-right: 10px"> <img class="rounded-circle"
                                                                src="{{ jadoo('assets/img/steps/favorite-placeholder.png') }}"
                                            ...
                                            <button class="btn"> <img
                                                    src="{{ jadoo('assets/img/steps/heart.svg') }}" width="20"
                                                    alt="step" /></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item position-relative active">
                                        <div class="card shadow" style="border-radius:10px;">
                                            <div class="position-absolute start-0 top-0 translate-middle"> <img
                                                    ...
                                                    src="{{ jadoo('assets/img/testimonial/author.png') }}"
                                    ...
                                    <div class="carousel-item position-relative ">
                                        <div class="card shadow" style="border-radius:10px;">
                                            <div class="position-absolute start-0 top-0 translate-middle"> <img
                                                    class="rounded-circle fit-cover"
                                                    src="{{ jadoo('assets/img/testimonial/author2.png') }}"
                                                    height="65" width="65" alt="" /></div>
                                            <div class="card-body p-4">
                                    ...
                                    <div class="carousel-item position-relative ">
                                        <div class="card shadow" style="border-radius:10px;">
                                            <div class="position-absolute start-0 top-0 translate-middle"> <img
                                                    class="rounded-circle fit-cover"
                                                    src="{{ jadoo('assets/img/testimonial/author3.png') }}"
                                                    height="65" width="65" alt="" /></div>
                                            <div class="card-body p-4">
                                                <p class="fw-medium mb-4">&quot;On the Windows talking painted pasture
                                                    yet its express parties use. Sure last upon he same as knew next. Of
                    ...
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="{{ jadoo('assets/img/partner/1.png') }}" alt="" /></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="{{ jadoo('assets/img/partner/2.png') }}" alt="" /></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="{{ jadoo('assets/img/partner/3.png') }}" alt="" /></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="{{ jadoo('assets/img/partner/4.png') }}" alt="" /></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="{{ jadoo('assets/img/partner/5.png') }}" alt="" /></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="py-8 px-5 position-relative text-center"
                    ...
                    <div class="position-absolute start-100 top-0 translate-middle ms-md-n3 ms-n4 mt-3"> <img
                            src="{{ jadoo('assets/img/cta/send.png') }}" style="max-width:70px;" alt="send icon" />
                    </div>
                    <div class="position-absolute end-0 top-0 z-index--1"> <img
                            src="{{ jadoo('assets/img/cta/shape-bg2.png') }}" width="264" alt="cta shape" /></div>
                    <div class="position-absolute start-0 bottom-0 ms-3 z-index--1 d-none d-sm-block"> <img
                            src="{{ jadoo('assets/img/cta/shape-bg1.png') }}" style="max-width: 340px;"
                            alt="cta shape" /></div>
                                ...
                                <div class="col-sm">
                                    <div class="input-group-icon">
                                        <input class="form-control form-little-squirrel-control" type="email"
                                            ...
                                            src="{{ jadoo('assets/img/cta/mail.svg') }}" width="17" alt="mail" />
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-7 col-12 mb-4 mb-md-6 mb-lg-0 order-0"> <img class="mb-4"
                            src="{{ jadoo('assets/img/logo2.svg') }}" width="150" alt="jadoo" />
                    ...
                    <div class="col-lg-3 col-md-5 col-12 mb-4 mb-md-6 mb-lg-0 order-lg-4 order-md-1">
                        ...
                        <div class="d-flex align-items-center"> <a href="#!"> <img class="me-2"
                                    src="{{ jadoo('assets/img/play-store.png') }}" alt="play store" /></a><a
                                href="#!"> <img src="{{ jadoo('assets/img/apple-store.png') }}"
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{ jadoo('vendors/@popperjs/popper.min.js') }}"></script>
    <script src="{{ jadoo('vendors/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ jadoo('vendors/is/is.min.js') }}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{ jadoo('vendors/fontawesome/all.min.js') }}"></script>
    <script src="{{ jadoo('assets/js/theme.js') }}"></script>
